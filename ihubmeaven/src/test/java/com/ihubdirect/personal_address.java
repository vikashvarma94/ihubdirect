...
public class personal_address extends baseclass {
  @Test
  public void f() throws InterruptedException {
	  ...
	  driver.get("http://183.82.123.14/iHubMultiStoresDirectDev");
		...
		// Update
		driver.findElement(By.xpath("//div[@id=\"EditBuyerDetailsFormModal\"]//button[@ng-click=\"Update_Buyer_Details('PersonalDetailsForm')\"]"))
				.click();
		// Cancel
